...
window.onload = function () {
    ...
    imgHero.onload = function() {
        ...
        function drawHero() {
            ...
            holst.drawImage(imgHero, xHero, yHero, sizeHero, sizeHero);
        }
            ...
            if (kwa.length !== 0) {
                ...
                kwa.forEach(function (k_el, indx, mas) {
                    ...
                    if (flagX === true && flagY === true) {
                        mas.splice(indx, 1);
                        score = score + 1000 - deltaScore;
                        scoreBox.innerHTML = "Очки: " + score;
                    }
                });
            } else if (deltaScore > 10) {
                clearInterval(inter_2);
                clearInterval(interDeltaScore);
                clearInterval(inter_1);
                scoreBox.innerHTML = "Результат игры = " + score;
                alert("Game over")
            }

        }, 30);

        let interDeltaScore = setInterval(function () {
